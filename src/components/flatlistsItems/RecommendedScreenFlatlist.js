...
export default function RecommendedScreenFlatlist({image}) {
      ...
      <View style={styles.container}>
        <View style={styles.cardContainerBody}>
          ...
          <View style={styles.cardContainerBodyPadding}>
            <View>
              <Text style={styles.rewardsText}>2X cash rewards on dining</Text>
            </View>
            <View style={styles.feeContainer}>
              <Text style={styles.feeText}>Joining Fee: ₹1000</Text>
              <Text style={styles.feeText}>Annual Fee: ₹1500</Text>
            </View>
          </View>
        </View>
        {showModal && (
